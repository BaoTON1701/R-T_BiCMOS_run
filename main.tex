...
\begin{table}[ht]
    ...
    \resizebox{\textwidth}{!}{%
        ...
        \begin{tabularx}{1.55\textwidth}{l|l|m{3.5cm}|c|ccc|c|ccc|c|c}
            ...
            \hline
            CMRR    & Common-mode Rejection Ratio   & \centering $V_{S} \pm 1.65\text{V}$ | LNA1 & & 112 & 128 & 161 & 1 &  &  &  & 2,3 & \text{dB} \\
                     &       & \centering $V_{S} \pm 1.65\text{V}$ | LNA2    & & 112 & 124 & 156 & 1 &  &  &  & 2,3 & \text{dB} \\
            \hline
...
\begin{multicols}{2}
    \begin{figure}[H]
        ...
        \captionof{figure}{MC shows the CMRR of the two LNAs vs Frequency from 1Hz to 100MHz at $27^\circ C$}
    \end{figure}  

    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{image/plot/CMRR_vs_T.png}
        \captionof{figure}{MC simulation shows the CMRR of the two LNAs vs Temperature from $-50^\circ C$ to $150^\circ C$ at 1 kHz}
    \end{figure}
\end{multicols}
% \pagebreak
...
\begin{multicols}{2}
    \begin{figure}[H]
        ...
        \captionof{figure}{MC simulation shows the PSRR of LNA1 (VCC,VEE) vs Frequency from 1Hz to 100MHz at $27^\circ C$}
    \end{figure}  

    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{image/plot/PSRR_LNA2.png}
        \captionof{figure}{MC simulation shows the PSRR of LNA2 (VCC,VEE) vs Frequency from 1Hz to 100MHz at $27^\circ C$}
    \end{figure}
\end{multicols}
