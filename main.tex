...
\begin{table}[ht]
    ...
    \resizebox{\textwidth}{!}{%
        ...
        \begin{tabularx}{1.55\textwidth}{l|l|m{3.5cm}|c|ccc|c|ccc|c|c}
            ...
            \hline
            CMRR    & Common-mode Rejection Ratio   & \centering $V_{S} \pm 1.65\text{V}$ | LNA1 & & 112 & 128 & 161 & 1 & 110 & 128 & 163 & 2,3 & \text{dB} \\
                     &       & \centering $V_{S} \pm 1.65\text{V}$ | LNA2    & & 112 & 124 & 156 & 1 & 110 & 123 & 147 & 2,3 & \text{dB} \\
            \hline
            PSRR    & Power Supply Rejection Ratio   & \centering $V_{S} \pm 1.65\text{V}$ | LNA1 & VCC @1kHz & 94 & 106 & 133 & 1 &  &  &  & 2,3 & \text{dB} \\
                    &                                &                                            & VEE @1kHz & 92 & 108 & 137 & 1 &  &  &  & 2,3 & \text{dB} \\
                     &                               & \centering $V_{S} \pm 1.65\text{V}$ | LNA2 & VCC @1kHz & 94 & 106 & 133 & 1 &  &  &  & 2,3 & \text{dB} \\
                    &                                &                                            & VEE @1kHz & 92 & 104 & 135 & 1 &  &  &  & 2,3 & \text{dB}
        \end{tabularx}%
    }
\end{table}
\newpage
