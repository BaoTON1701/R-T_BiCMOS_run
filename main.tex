...
\begin{table}[ht]
    ...
    \resizebox{\textwidth}{!}{%
        ...
        \begin{tabularx}{1.55\textwidth}{l|l|m{3.5cm}|c|ccc|c|ccc|c|c}
            ...
            \hline
            SR    & Slew Rate   & \centering $V_{in} \pm 1.25~m\text{V}$ | LNA1 & & 28 & 30 & 31 & 1 & 28 & 30 & 32 & 2,3 & $V/\mu s$ \\
                     &       & \centering $V_{in} \pm 1.25~m\text{V}$ | LNA2 (tbu \footnote{to be updated})               & & -50 & -23 & & 1 & -100 & & & 2,3 & $/\mu s $ \\
        \end{tabularx}%
    }
\end{table}
\end{document}