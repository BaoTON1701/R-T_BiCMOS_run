...
\begin{center} 
        ...
        \label{fig:PSRR_LNA1_VCC}
    \end{center}    
\begin{center} 
        \includegraphics[width=\linewidth]{image/plot/PSRR_LNA1_VEE.png}
        \label{fig:PSRR_LNA1_VEE}
    \end{center}
\end{multicols} 
\begin{multicols}{2}
\begin{center} 
