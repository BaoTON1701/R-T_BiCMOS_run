...
\begin{table}[ht]
    ...
    \resizebox{\textwidth}{!}{%
        ...
        \begin{tabularx}{1.55\textwidth}{l|l|m{3.5cm}|c|ccc|c|ccc|c|c}
            ...
            \multirow{2}{*}{\parbox{1.5cm}{\centering \textbf{NOTES}}} & 
            ...
            $V_{OS}$ & Input Offset & \centering $V_S = \pm 1.65\text{V}$ & & & 0.6 & 2 &  & & & 4 & 2,3 & mV \\
                     & Voltage      & \centering $V_{CM} = V^-\text{ to }V^+$ & & & 2.5 & 6 &  & & & 9 & 2,3 & mV \\
            \hline
            $I_B$    & Input Bias   & \centering $V_S = \pm 1.65\text{V}$ & & & 8 & 18 &  & & & 20 & 2,3 & $\mu$A \\
                     & Current      & \centering $V_{CM} = V^+$               & & -50 & -23 & &  & -100 & & & 2,3 & $\mu$A \\
            \hline
                & Input Noise   & \centering $0.1~Hz$ to $10~Hz$ & & & 8 & 18 &  & & & 20 & 2,3 & $\mu$A \\
                     & Voltage      & \centering $V_{CM} = V^+$               & & -50 & -23 & &  & -100 & & & 2,3 & $nV_{p-p}$ \\
            \hline
            SR    & Slew Rate   & \centering $V_{in} \pm 1.25~m\text{V}$ | LNA1 & & 28 & 30 & 31 &  & 29 & 30 & 32 & 2,3 & $V/\mu s$ \\
                     &       & \centering $V_{in} \pm 1.25~m\text{V}$ | LNA2    & & 39 & 36 & 42 &  & 38 & 39 & 40 & 2,3 & $/\mu s $ \\
            \hline
            CMRR    & Common-mode Rejection Ratio   & \centering $V_{S} \pm 1.65\text{V}$ | LNA1 & & 112 & 128 & 161 &  & 110 & 128 & 163 & 2,3 & \text{dB} \\
                     &       & \centering $V_{S} \pm 1.65\text{V}$ | LNA2    & & 112 & 124 & 156 &  & 110 & 123 & 147 & 2,3 & \text{dB} \\
            \hline
            PSRR    & Power Supply Rejection Ratio   & \centering $V_{S} \pm 1.65\text{V}$ | LNA1 &  & 94 & 106 & 133 & VCC @1kHz & 89 & 107 & 140 & 2,3 & \text{dB} \\
                    &                                &                                            &  & 92 & 108 & 137 & VEE @1kHz & 91 & 109 & 141 & 2,3 & \text{dB} \\
                     &                               & \centering $V_{S} \pm 1.65\text{V}$ | LNA2 &  & 94 & 106 & 133 & VCC @1kHz & 91 & 106 & 131 & 2,3 & \text{dB} \\
                    &                                &                                            &  & 92 & 104 & 135 & VEE @1kHz & 89 & 104 & 130 & 2,3 & \text{dB}
        \end{tabularx}%
    }
\end{table}
\newpage
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{image/plot/CMRR_vs_f.png}
        \captionof{figure}{CMRR of LNA1/LNA2 vs Frequency (\qtyrange{1}{100}{\MHz}) at \qty{27}{\celsius}}
    \end{figure}  

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\linewidth]{image/plot/CMRR_vs_T.png}
        \captionof{figure}{CMRR of LNA1/LNA2 vs Temperature (\qtyrange{-50}{150}{\celsius}) at \qty{1}{\kHz}}
    \end{figure}
\end{multicols}
\pagebreak
\subsection*{Power Suppy Rejection Ratio (PSRR)}

\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{image/plot/PSRR_LNA1.png}
        \captionof{figure}{LNA1 PSRR (VCC, VEE) vs Frequency (\qtyrange{1}{100}{\MHz}) at \qty{27}{\celsius}}
    \end{figure}  

    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{image/plot/PSRR_LNA2.png}
        \captionof{figure}{LNA2 PSRR (VCC, VEE) vs Frequency (\qtyrange{1}{100}{\MHz}) at \qty{27}{\celsius}}
    \end{figure}
\end{multicols}
...
\begin{multicols}{2}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{image/plot/PSRR_vs_T_LNA1.png}
        \captionof{figure}{LNA1 PSRR (VCC, VEE) of LNA1 vs Frequency (\qtyrange{1}{100}{\MHz}) at \qty{27}{\celsius}}
    \end{figure}  

    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{image/plot/PSRR_vs_T_LNA2.png}
        \captionof{figure}{LNA2 PSRR (VCC, VEE) of LNA2 vs Frequency (\qtyrange{1}{100}{\MHz}) at \qty{27}{\celsius}}
    \end{figure}
\end{multicols}
